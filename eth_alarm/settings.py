...
TEMPLATE_DIRS = (
    os.path.join(BASE_DIR, 'eth_alarm', 'templates'),
)
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'eth_alarm.apps.core.context_processors.rollbar',
)
...
ROOT_URLCONF = 'eth_alarm.urls'

WSGI_APPLICATION = 'eth_alarm.wsgi.application'
